...
/**
 * is_cdir - Checks if a character in the PATH string is a colon separator.
...
/**
 * _which - Locates the full path to an executable command.
...
/**
 * is_executable - Checks if a command is executable.
...
/**
 * check_error_cmd - Checks if there is an error in the command.
 * @dir: The full path to the command.
 * @datash: The data shell structure.
 *
...
/**
 * cmd_exec - Executes a command in a new process.
 * @datash: The data shell structure.
 *
